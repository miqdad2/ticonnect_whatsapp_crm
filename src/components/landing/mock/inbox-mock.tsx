      ...
      <div className="grid grid-cols-[180px_1fr] lg:grid-cols-[220px_1fr]">
          ...
          {[
            ...
            <div
              ...
              className={`flex items-start gap-2 px-3 py-2.5 ${
                c.active ? 'border-l-2 border-sky-500 bg-slate-800/60' : 'border-l-2 border-transparent'
              }`}
            >
              <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-sky-500/10 text-[10px] font-medium text-sky-400">
                {c.name[0]}
              </span>
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-2">
                  <span className="truncate text-xs font-medium text-white">{c.name}</span>
                  {c.unread && <span className="h-1.5 w-1.5 rounded-full bg-sky-500" />}
                </div>
        ...
        <div className="flex min-h-[280px] flex-col bg-slate-950">
          <div className="flex items-center gap-2 border-b border-slate-800 px-4 py-2.5">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-sky-500/10 text-[10px] font-medium text-sky-400">
              A
            </span>
            <div>
            ...
            <div className="ml-auto inline-flex items-center gap-1 rounded-full border border-sky-500/30 bg-sky-500/10 px-2 py-0.5 text-[10px] text-sky-300">
              Open
            </div>
          </div>
          ...
          <div className="flex flex-1 flex-col gap-2 px-4 py-4">
            ...
            <div className="ml-auto max-w-[75%] rounded-2xl rounded-br-sm bg-sky-600 px-3 py-2 text-xs text-white">
              Yes, shipping today.
            </div>
            <div className="mr-auto max-w-[75%] rounded-2xl rounded-bl-sm bg-slate-800 px-3 py-2 text-xs text-slate-200">
              Thanks! Received it.
