      ...
      <div className="space-y-2 border-b border-slate-800 p-3">
        <div className="relative">
          ...
          <Input
            ...
            className="border-slate-700 bg-slate-800 pl-9 text-sm text-white placeholder-slate-500 focus:border-sky-500/50"
          />
        </div>
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive && "border-l-2 border-sky-500 bg-slate-800/70"
      )}
    >
      {/* Avatar */}
