...
const STEP_META: Record<AutomationStepType, StepMeta> = {
  send_message: { label: "Send Message", icon: MessageSquare, border: "border-l-sky-500" },
  send_template: { label: "Send Template", icon: FileText, border: "border-l-sky-500" },
  add_tag: { label: "Add Tag", icon: Tag, border: "border-l-sky-500" },
  remove_tag: { label: "Remove Tag", icon: TagIcon, border: "border-l-sky-500" },
  assign_conversation: { label: "Assign Conversation", icon: UserCheck, border: "border-l-sky-500" },
  update_contact_field: { label: "Update Contact Field", icon: PencilLine, border: "border-l-sky-500" },
  create_deal: { label: "Create Deal", icon: Briefcase, border: "border-l-sky-500" },
  ...
  send_webhook: { label: "Send Webhook", icon: Webhook, border: "border-l-sky-500" },
  close_conversation: { label: "Close Conversation", icon: CircleSlash, border: "border-l-sky-500" },
}
          ...
          <div className="space-y-3 border-t border-slate-800 px-4 py-3">
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-slate-700 bg-slate-800 px-2 py-1.5 text-sm text-white focus:border-sky-500 focus:outline-none"
              >
...
function ConditionBranches({
  ...
  return (
    ...
    <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
      <BranchColumn label="Yes" color="text-sky-400">
...
function AddButton({ onPick }: { onPick: (t: AutomationStepType) => void }) {
  return (
    <div className="relative flex flex-col items-center">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-dashed border-slate-700 bg-slate-950 text-slate-400 transition-colors hover:border-sky-500 hover:bg-sky-500/10 hover:text-sky-400 data-[popup-open]:border-sky-500 data-[popup-open]:bg-sky-500/20 data-[popup-open]:text-sky-400"
          aria-label="Add step"
        >
