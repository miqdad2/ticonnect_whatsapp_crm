    ...
    <div className="space-y-6">
            ...
            return (
              ...
              >
                <div className="mb-3 flex items-center gap-2">
                  <span className="inline-flex items-center rounded-md bg-sky-500/10 px-2 py-0.5 text-xs font-mono font-medium text-sky-400">
                    {placeholder}
                  </span>
                </div>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4">
        ...
        <div className="rounded-lg bg-[#0e1a12] p-3">
          <div className="ml-auto max-w-[85%] rounded-lg bg-sky-700/30 px-3 py-2 shadow-sm">
