          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                className="h-9 w-full rounded-lg border border-slate-700 bg-slate-800 px-2.5 text-sm text-white outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
              >
              ...
              {linkedConversation && (
                <Link
                  href="/inbox"
                  className="mt-1 inline-flex items-center gap-1.5 self-start rounded-md bg-sky-500/10 px-2 py-1 text-xs text-sky-400 hover:bg-sky-500/20"
                >
            ...
            <div className="grid grid-cols-[1fr_110px] gap-3">
              ...
              <div className="grid gap-2">
                ...
                <select
                  ...
                  className="h-9 w-full rounded-lg border border-slate-700 bg-slate-800 px-2.5 text-sm text-white outline-none focus:border-sky-500"
                >
              ...
              <div className="space-y-2 rounded-lg border border-slate-700 bg-slate-900/50 p-3">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex-1 bg-sky-600 text-white hover:bg-sky-700 disabled:opacity-50"
                  >
                    {statusAction === "won" ? (
