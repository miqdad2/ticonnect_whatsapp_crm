      ...
      <DialogContent className="bg-slate-900 border-slate-700 text-slate-200 sm:max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-slate-700 p-6 cursor-pointer hover:border-sky-500/50 transition-colors"
          >
            {file ? (
              <>
